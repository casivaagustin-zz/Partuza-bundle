...
class Auth_Yadis_XMLParser {
   ...
   * false otherwise.
   */
  function registerNamespace($prefix, $uri) {  // Not implemented.
  }
   ...
   * false otherwise.
   */
  function setXML($xml_string) {  // Not implemented.
  }
   ...
   */
  function evalXPath($xpath, $node = null) {  // Not implemented.
  }
   ...
   */
  function content($node) {  // Not implemented.
  }
   ...
   * values.
   */
  function attributes($node) {  // Not implemented.
  }
}
